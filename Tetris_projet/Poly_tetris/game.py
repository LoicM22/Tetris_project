...
# setting caption
    ...
    delay = 0
    score = 0
    myfont = pygame.font.SysFont('Early GameBoy', 10)     # modification police interface
    myfont1 = pygame.font.SysFont('Fira Mono', 35)  # modification police nom du joueur
    myfont3 = pygame.font.SysFont('Early GameBoy', 50)
    slowtimedelay = 0
    leftKey = False
    rightKey = False
    downKey = False
...
while not started:  # Title screen
    titlescreen = pygame.image.load('background.png')
